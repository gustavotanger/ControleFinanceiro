            ...
            <div id="page-inner">
                ...
                <form action="alterar_empresa.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" placeholder="Digite o Telefone aqui..." name="tele" id="tele" value="<?= $dados[0]['telefone_empresa'] ?>"/>
                    </div>
                    <div class="form-group">
                        <label>Digite o Endereço da Empresa:</label>
                        <input type="text" class="form-control" placeholder="Digite o Endereço aqui..." name="local" id="local" value="<?= $dados[0]['endereco_empresa'] ?>"/>
                    </div>
