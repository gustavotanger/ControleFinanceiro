            ...
            <div id="page-inner">
                ...
                <form action="alterar_categoria.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Digite o Nome da Categoria aqui..." name="nomeCtg" id="nomeCtg" value="<?= $dados[0]['nome_categoria'] ?>"/>
                    </div>
